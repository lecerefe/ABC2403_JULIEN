...
public class App {
	...
	public static void main(String[] args) {
		...
		*/
		...
		public static String getFullName(String fullName, String lastName) {
			return fullName.toUpperCase() + " " + lastName;
		}
		
		public static String askUser(String fullName, String lastName) {
			String mc2;
			mc2 = "connaissez-vous "+ App.getMC2() +" ? ";
			return "Bonjour " + App.getFullName(fullName, lastName) + " " + mc2;
		}
}
