...
paye est un float
total est un float
montantPaye est un float
renduMonnaie est un float
billets5Euro est un entier
piece2Euro est un entier
piece50Cents est un entier
piece20Cents est un entier
piece10Cents est un entier
